        ...
        <div className="prep-panel">
            ...
            <div className="import-section">
                ...
                <div className="import-input-wrapper">
                    ...
                    >
                        {isFetchingPdb ? (
                            <><div className="btn-spinner" /> Fetching...</>
                        ) : (
                            <>📥 Fetch</>
                        )}
                    </button>
                ...
                {pdbError && <div className="import-error">⚠️ {pdbError}</div>}
            ...
            <div className="import-section">
                ...
                {pubchemError && <div className="import-error">⚠️ {pubchemError}</div>}
            ...
            {error && <div className="prep-error"><span>⚠️</span> {error}</div>}
            ...
            <div className="conversion-section active">
                ...
                <div className="conversion-content">
                    ...
                    >
                        {isConverting ? (
                            <><div className="btn-spinner" /> Converting...</>
                        ) : (
                            <>⚡ Convert</>
                        )}
                    </button>
                    ...
                    {conversionError && (
                        <div className="conversion-error">⚠️ {conversionError}</div>
                    )}
